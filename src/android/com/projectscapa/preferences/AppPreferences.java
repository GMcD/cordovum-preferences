package com.projectscapa.preferences;
...
public class AppPreferences extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) {
        ...
        // First install, we pull from XML
        PreferenceManager.setDefaultValues(this.cordova.getActivity(), R.xml.preferences, false);
        // Second update with Footprint.deviceId
		Editor ed = sharedPrefs.edit();
		ed.putString("deviceId", Footprint.deviceId());
		ed.commit();
        ...
        try {
            if (action.equals("get")) {
                ...
                obj.put("reachable", Footprint.isReachable());
